...
class UserSessionControllerTest extends TestCase
{
    ...
    public function testIndexReturnsRealSessionsWithoutFakeFallback(): void
    {
    ...
    public function testUserCanRevokeOwnSession(): void
    {
        $user = User::factory()->create();
        [$token] = $this->createSessionForUser($user);
    ...
    public function testRevokedSessionTokenIsRejectedOnNextRequest(): void
    {
        $user = User::factory()->create();
        [$token] = $this->createSessionForUser($user);
    ...
    public function testUserCannotRevokeAnotherUsersSession(): void
    {
        $user      = User::factory()->create();
    ...
    public function testRevokeOthersKeepsCurrentSessionActive(): void
    {
        $user = User::factory()->create();
