...
use App\Domain\Common\Support\DefaultMediaPathGenerator;
use App\Domain\Common\Support\TenantMediaPathGenerator;
use App\Domain\Common\Support\UserMediaPathGenerator;
...
return [
     ...
     */
    'path_generator' => DefaultMediaPathGenerator::class,
    ...
    'custom_path_generators' => [
        ...
        Tenant::class => TenantMediaPathGenerator::class,
        Contractor::class => TenantMediaPathGenerator::class,
        Project::class => TenantMediaPathGenerator::class,
        Task::class => TenantMediaPathGenerator::class,
        Expense::class => TenantMediaPathGenerator::class,
        Invoice::class => TenantMediaPathGenerator::class,
    ],
