...
Route::middleware(['auth:api', 'session.active', 'is_active', 'is_in_tenant'])->prefix('financial-reports')->group(function () {
...
Route::middleware(['auth:api', 'session.active', 'is_active'])->prefix('pkwiu')->group(function () {
