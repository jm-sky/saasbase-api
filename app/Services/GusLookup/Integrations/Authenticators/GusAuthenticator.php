...
namespace App\Services\GusLookup\Integrations\Authenticators;
...
class GusAuthenticator implements Authenticator
{
    public const CACHE_TTL = 60 * 60; // 60 minutes

    protected string $CACHE_KEY = 'gus_lookup.y.session_key';

    public function __construct()
    {
        $isTest = Str::contains(config('gus_lookup.api_url'), 'wyszukiwarkaregontest');
