...
enum FeatureName: string
{
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::STORAGE_GB              => 'Storage space in gigabytes',
    ...
    {
        return match ($this) {
            self::MAX_USERS, self::STORAGE_GB, self::MAX_INVOICES, self::GUS_VIES_REQUESTS => 'integer',
    ...
    {
        return match ($this) {
            self::MAX_USERS, self::STORAGE_GB, self::MAX_INVOICES, self::GUS_VIES_REQUESTS => '0',
            self::KSEF_INTEGRATION, self::EDORECZENIA_INTEGRATION,
